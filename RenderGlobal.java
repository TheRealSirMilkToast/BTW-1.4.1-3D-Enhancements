        ...
        if (this.mc != null && this.mc.renderViewEntity != null && this.mc.effectRenderer != null)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    //3D Infernal Enchanter Flame FX
                    else if ( par1Str.equals( "TDEInfernalEnchanterFlame" ) )
                    {
                		var21 = EntityList.createEntityOfType(EntityInfernalEnchanterFlameFX.class, this.theWorld, par2, par4, par6, par8, par10, par12);
                    }
